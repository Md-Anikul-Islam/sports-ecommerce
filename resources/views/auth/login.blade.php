                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="auth-brand p-4">
                                    <a href="{{ url('/') }}" class="logo-light">
                                        <img src="{{ asset('backend/images/wings.png') }}" alt="logo" height="100">
                                    </a>
                                    <a href="{{ url('/') }}" class="logo-dark">
                                        <img src="{{ asset('backend/images/wings.png') }}" alt="dark logo" height="100">
                                    </a>
                                </div>
...
<footer class="footer footer-alt fw-medium">
    <span class="text-dark">
        <script>document.write(new Date().getFullYear())</script> © Wings
    </span>
</footer>
