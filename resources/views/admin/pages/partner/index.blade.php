            ...
            <div class="card-body">
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    @foreach($partner as $key=>$partnerData)
                        <tr>
                            <td>{{$key+1}}</td>
                            <td>{{$partnerData->title}}</td>
                            <td>
                             <img src="{{asset('images/partner/'. $partnerData->image )}}" alt="Current Image" style="max-width: 50px;">
                             </td>
                            ...
                            <td style="width: 100px;">
                                <div class="d-flex justify-content-end gap-1">
                                    ...
                                    <a href="{{route('admin.partner.destroy',$partnerData->id)}}"class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#danger-header-modal{{$partnerData->id}}">Delete</a>
                                </div>
                            </td>
                            <!--Edit Modal -->
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{route('admin.partner.update',$partnerData->id)}}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="title" name="title" value="{{$partnerData->title}}"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <img src="{{asset('images/partner/'. $partnerData->image )}}" alt="File or  Image" class="mt-2" style="max-width: 50px;">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="mb-3">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{route('admin.partner.destroy',$partnerData->id)}}" class="btn btn-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
