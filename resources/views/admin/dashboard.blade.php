        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card widget-flat text-bg-purple">
                <div class="card-body">
                    ...
                    <h6 class="text-uppercase mt-0" title="Customers">Total Product</h6>
        ...
        <div class="col-xxl-3 col-sm-6">
            <div class="card widget-flat text-bg-primary">
                <div class="card-body">
                    ...
                    <h6 class="text-uppercase mt-0" title="Customers">Total Order Delivered </h6>
                    <h2 class="my-2">{{$totalOrderDelivered}}</h2>
                </div>
            </div>
        </div>
    </div>
