...
<html lang="en">
    ...
    <body>
        ...
        <header class="header_area sticky-top">
           ...
           <form action="{{ route('frontend.all.product') }}" class="search-box">
                <div class="input_wrap">
                    <input type="text" class="text search-input" name="search" placeholder="Type here to search..." />
        ...
        >
            @yield('content')
            <!-- Follow us on -->
            <section class="follow_us_section text-center">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="follow_us">
